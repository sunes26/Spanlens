...
import { Zap, Key, Code, CheckCircle } from 'lucide-react'
...
export default function OnboardingPage() {
  ...
  const proxyUrls: Record<string, string> = {
    openai: 'https://proxy.spanlens.io/openai',
    anthropic: 'https://proxy.spanlens.io/anthropic',
    gemini: 'https://proxy.spanlens.io/gemini',
  }
